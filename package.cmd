...
powershell -NoProfile -Command "Compress-Archive -Path '%DIST%\*' -DestinationPath '%~dp0dist\routerAI-0.7.1-windows-x64.zip' -Force"
if errorlevel 1 exit /b %errorlevel%

echo Portable package: %~dp0dist\routerAI-0.7.1-windows-x64.zip
endlocal
